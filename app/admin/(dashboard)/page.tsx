...
import { Server, Users, ShieldAlert, Activity, Database, HardDrive, AlertTriangle, Cpu, Terminal } from 'lucide-react';
  ...
  useEffect(() => {
    const fetchMetrics = async () => {
      try {
        ...
        // console.warn("Waiting for backend API...", err);
      }
    };
        ...
        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow group relative overflow-hidden">
          ...
          <div className="flex items-center justify-between relative z-10">
            <div>
              ...
              <h3 className="text-3xl font-bold text-gray-900">42<span className="text-sm font-normal text-gray-500 ml-1">명</span></h3>
            </div>
