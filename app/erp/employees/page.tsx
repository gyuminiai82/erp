            ...
            <div className="p-6 overflow-y-auto max-h-[70vh]">
              <div className="mb-6 p-3 bg-blue-50 border border-blue-100 rounded-lg flex items-center gap-2 text-sm text-blue-800 shadow-sm">
                ...
                <p className="text-blue-700/90 whitespace-nowrap">
                  하단의 <strong className="text-blue-900">[표에 임시 추가]</strong> 후, 반드시 표 상단의 <strong className="text-blue-900 bg-white px-1 py-0.5 rounded border border-blue-200">[변경사항 저장]</strong>을 눌러야 최종 반영됩니다.
                </p>
              </div>
